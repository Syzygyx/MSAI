...
scp -i $KEY_FILE -o StrictHostKeyChecking=no ec2_deploy_script.sh ubuntu@$EC2_IP:/tmp/

# Execute deployment script on EC2
echo "🚀 Executing deployment on EC2..."
ssh -i $KEY_FILE -o StrictHostKeyChecking=no ubuntu@$EC2_IP 'bash /tmp/ec2_deploy_script.sh'
