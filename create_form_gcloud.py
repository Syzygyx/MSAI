#!/usr/bin/env python3
"""
Create Google Form using gcloud authentication
"""
...
def create_form_with_gcloud():
    """Create Google Form using gcloud authentication"""
    
    # First, let's create a simple form using the Google Forms API
    form_data = {
        "info": {
    ...
    # Use gcloud to create the form
    print("🚀 Creating Google Form using gcloud...")
    
    # First, let's try to create a form using the Google Forms API
    create_command = f"""
    gcloud auth application-default print-access-token | xargs -I {{}} curl -X POST \\
    ...
    print("Running form creation command...")
    result = run_gcloud_command(create_command)
