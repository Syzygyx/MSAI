#!/usr/bin/env python3
"""
Simple Google Drive setup using direct service account authentication
"""
...
def create_shared_drive(access_token):
    ...
    try:
        response = requests.post(url, headers=headers, json=data, params={"requestId": "msai-drive-003"})
