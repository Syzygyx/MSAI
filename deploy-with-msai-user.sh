#!/bin/bash
# Deploy MS AI Curriculum System with msai user

set -e

echo "🚀 Deploying MS AI Curriculum System with msai user..."
...
echo "Launching new instance with msai user..."
INSTANCE_ID=$(aws ec2 run-instances \
    ...
    --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=msai-curriculum-system}]' \
...
# Update DNS
echo "Updating DNS with msai user..."
...
echo "✅ Deployment complete with msai user!"
...
echo ""
echo "🎉 MS AI Curriculum System is now live!"