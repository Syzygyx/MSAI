#!/bin/bash
# Simple EC2 deployment for MS AI Curriculum System

EC2_IP="44.220.164.13"
KEY_FILE="msai-production-key.pem"

echo "🚀 Deploying MS AI Curriculum System to EC2..."
    ...
    <section id="demo" class="demo">
        <div class="container">
            ...
            <div class="demo-buttons">
                ...
                <a href="/api/courses" class="demo-btn">
                    <i class="fas fa-book"></i> Explore Courses
                </a>
                <a href="/api/tracks" class="demo-btn">
                    <i class="fas fa-graduation-cap"></i> Specialization Tracks
                </a>
                <a href="/api/curriculum" class="demo-btn">
                    <i class="fas fa-brain"></i> Full Curriculum
                </a>
...
scp -i $KEY_FILE -o StrictHostKeyChecking=no ec2_setup.sh ubuntu@$EC2_IP:/tmp/

# Execute deployment script on EC2
echo "🚀 Executing deployment on EC2..."
ssh -i $KEY_FILE -o StrictHostKeyChecking=no ubuntu@$EC2_IP 'bash /tmp/ec2_setup.sh'

echo "🎉 Deployment completed!"
echo "📍 EC2 Instance: $EC2_IP"
echo "🌐 Application: http://$EC2_IP:8000"
echo "📊 Next: Update Route 53 DNS to point to this IP"