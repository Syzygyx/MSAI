#!/bin/bash
# MS AI Curriculum System - Complete Deployment Script
...
apt-get install -y python3 python3-pip python3-venv nginx certbot python3-certbot-nginx git curl wget
...
Now let me create a new EC2 instance with this user data:
